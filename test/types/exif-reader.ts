...
expandedTags['exif']?.['DateTimeOriginal']?.description === '2014:09:21 16:00:56';
// @ts-expect-error
...
expandedTags['xmp']?.['DateTimeOriginal'].attributes['some-key'] === 'some value';
expandedTags['xmp']?.['DateTimeOriginal'].attributes['some-key'] === 'some value';
// @ts-expect-error
