...
(function() {
  (typeof exports !== "undefined" && exports !== null ? exports : this).ExifReader = (function() {
    ...
    ExifReader.prototype._COMMENT_MARKER = 0xfffe;
    ...
    ExifReader.prototype._getString = function(dataView, offset, length) {
      ...
      chars = (function() {
        ...
        for (i = j = 0, ref = length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
          results.push(dataView.getUint8(offset + i, false));
        }
        return results;
      })();
    ...
    ExifReader.prototype._isAppMarker = function(dataView, appMarkerPosition) {
      ...
      return appMarker >= this._APP0_MARKER && appMarker <= this._APP15_MARKER || appMarker === this._COMMENT_MARKER;
    };
    ...
    ExifReader.prototype._parseIptcTags = function(naaBlock) {
      var endOfBlockOffset, results, tag;
      ...
      while (true) {
        ...
        if ((this._tags[tag.name] == null) || (tag['repeatable'] == null)) {
          results.push(this._tags[tag.name] = {
            'value': tag.value,
            'description': tag.description
          });
        } else {
          ...
          results.push(this._tags[tag.name].push({
            'value': tag.value,
            'description': tag.description
          }));
        }
    ...
    ExifReader.prototype._readIptcTag = function() {
      ...
      if (this._tagNames['iptc'][tagCode] != null) {
        if ((this._tagNames['iptc'][tagCode]['name'] != null) && (this._tagNames['iptc'][tagCode]['description'] != null)) {
          ...
          tagName = (ref = this._tagNames['iptc'][tagCode]['name']) != null ? ref : this._tagNames['iptc'][tagCode];
          if (tagValue instanceof Array) {
    ...
    ExifReader.prototype._getIptcTagValue = function(offset, size) {
      ...
      value = (function() {
        var j, ref, results;
        results = [];
        for (valueIndex = j = 0, ref = size; 0 <= ref ? j < ref : j > ref; valueIndex = 0 <= ref ? ++j : --j) {
          results.push(this._dataView.getUint8(offset + valueIndex));
        }
        return results;
      }).call(this);
      return value;
    ...
    ExifReader.prototype._tagNames = {
      ...
      'gps': {
        0x0000: {
          ...
          'description': function(value) {
            var ref, ref1;
            if ((value[0] === (ref = value[1]) && ref === 2) && (value[2] === (ref1 = value[3]) && ref1 === 0)) {
              return 'Version 2.2';
            } else {
              return 'Unknown';
            }
          ...
          'description': function(value) {
            ...
            padZero = function(num) {
              ...
              return ((function() {
                var j, ref, results;
                results = [];
                for (i = j = 0, ref = 2 - ('' + Math.floor(num)).length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
                  results.push('0');
                }
                return results;
              })()) + num;
      ...
      'iptc': {
        ...
        0x02c9: {
          ...
          'description': function(value, exif) {
            var formatVersions, ref, stringValue;
            formatVersions = {
              '00': {
                '00': '1'
              },
            ...
            stringValue = ExifReader.prototype._getStringValue(value);
            if ((exif._tags['ObjectData Preview File Format'] != null) && (((ref = formatVersions[ExifReader.prototype._getStringValue(exif._tags['ObjectData Preview File Format'].value)]) != null ? ref[stringValue] : void 0) != null)) {
